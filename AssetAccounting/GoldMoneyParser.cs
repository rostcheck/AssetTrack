...
namespace AssetAccounting
{
	public class GoldMoneyParser : ParserBase, IFileParser
	{
		...
		private AssetTypeEnum metalType;
		private AssetMeasurementUnitEnum weightUnit;
		...
		private static AssetMeasurementUnitEnum GetWeightUnit(AssetTypeEnum metalType)
		{
			switch (metalType)
			{
				case AssetTypeEnum.Gold:
					return AssetMeasurementUnitEnum.Gram;
				case AssetTypeEnum.Silver:
					return AssetMeasurementUnitEnum.TroyOz;
				case AssetTypeEnum.Platinum:
					return AssetMeasurementUnitEnum.Gram;
				case AssetTypeEnum.Palladium:
					return AssetMeasurementUnitEnum.Gram;
				default:
		...
		private static AssetTypeEnum ParseMetalTypeFromFilename(string filenameIn)
		{
